...
public class AudioCenter {
    ...
    public void initialization(){
        ...
        System.out.println("If you want to add storage, please insert NEW INPUT");
        System.out.println("If you want to know info, please insert INFO ");
        System.out.println("If you want to remove storage, please insert REMOVE ");
        System.out.println("If you want to stop processing, please insert STOP ");
    ...
    public void newInput(){
        ...
        if(null == input) {System.out.println("Incorrect input. Try again."); this.newInput();} else
          switch (input) {
            case "CC":
                this.CC = true;
                System.out.println("CC succesfully set");
                break;
            case "CD":
                this.CD = true;
                System.out.println("CD succesfully set");
                break;
            case "USB":
                this.USB = true;
                System.out.println("USB succesfully set");
                break;
            default:
    ...
    public void infoOut(){
        ...
        System.out.println("Avalible storages: " + outs);
    ...
    public void remove(){
        ...
        if(null == input) {System.out.println("Incorrect input. Try again."); this.newInput();} else
          switch (input) {
            case "CC":
                this.CC = false;
                System.out.println("CC succesfully removed");
                break;
            case "CD":
                this.CD = false;
                System.out.println("CD succesfully removed");
                break;
            case "USB":
                this.USB = false;
                System.out.println("USB succesfully removed");
                break;
            default:
                System.out.println("Incorrect input. Try again.");
                this.newInput();
